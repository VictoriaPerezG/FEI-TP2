...
--
-- Servidor: localhost
-- Tiempo de generación: 31-10-2023 a las 01:41:42
...
--
ALTER TABLE `localidades`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2383;
...
--
ALTER TABLE `localidades`
  ADD CONSTRAINT `FKpsu514uguuo384j979ub9dp4y` FOREIGN KEY (`provincia_id`) REFERENCES `provincias` (`id`);
COMMIT;
